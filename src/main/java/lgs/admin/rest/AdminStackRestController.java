...
@RestController
@RequestMapping("/admin/stackapi")
public class AdminStackRestController {
	...
	public String add(@RequestParam Map<String,Object> param, HttpSession session) {
		...
		System.out.println(param.get("tectitle"));
